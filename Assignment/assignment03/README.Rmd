...
I was able to find 3,997 papers that show up under the term “sars-cov-2 trial vaccine.”
...
I can only find "covid" and "19" which are interesting because there are lots of stop words.
...
Yes, it does. After removing stop words, the word "covid" became the most frequent word.
...
After removing stop words, I created a list with the 5 most common tokens for each search term.
